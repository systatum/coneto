...
export function Calendar({
  ...
  const calendarClass = cn(
    "flex text-sm flex-col gap-1 bg-white border border-gray-300 rounded w-full p-3 shadow-xs min-w-[300px] list-none outline-none",
    className
  );
  ...
  return (
    ...
    >
      ...
      {mode === "day" ? (
            ...
            {days.map((date, i) => {
              ...
              return (
                ...
                >
                  <span
                    className={cn(
                      "w-6 h-6 p-[2px] rounded-full relative",
        ...
        <div className="flex flex-col max-h-[180px] scrollbar-thin overflow-y-scroll gap-1">
              ...
              >
                <span
                  className={cn(
                    ...
                    isDisableMonth && "text-gray-200 cursor-default"
                  )}
                >
                  {monthName}
