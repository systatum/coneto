...
describe("RichEditor", () => {
  ...
  context("tip menu heading", () => {
    ...
    headings.forEach((data) => {
      context(`When click menu heading ${data.label}`, () => {
        it(`should apply ${data.label} heading from dropdown`, () => {
      ...
      context(`When typing, click heading ${data.label}, and enter`, () => {
        it(`should apply ${data.label} heading and on the bottom render paragraph`, () => {
